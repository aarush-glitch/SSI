...
const EventDetailsForm = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await submitMicrobiologyForm(event_details_form);
      alert('Event Details form submitted successfully!');
  ...
  return (
    <form onSubmit={handleSubmit} style={styles.event_details_form}>
